...
%% Use segnetlayers to generate the same layergraph but with all weights initialized using MSRA
...
%% Train network!
[trainednetScratch, info] = trainNetwork(pximds,lgraphtransfer,options);
...
pxdsResultsScratch = semanticseg(imds,trainednetScratch, ...
    'MiniBatchSize',1, ...
    'Verbose',false);
