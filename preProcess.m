...
imLocation = 'C:\Users\Max Kivits\Documents\MATLAB\Bacheloropdracht\Data\Images';           %image directory
augLocation = 'C:\Users\Max Kivits\Documents\MATLAB\Bacheloropdracht\Data\augImages';
...
imLocation = 'C:\Users\Max Kivits\Documents\MATLAB\Bacheloropdracht\Data\Images';           %image directory
labLocation = 'C:\Users\Max Kivits\Documents\MATLAB\Bacheloropdracht\Data\Labels';          %label directory
augImgLocation = 'C:\Users\Max Kivits\Documents\MATLAB\Bacheloropdracht\Data\augImages';    %output directories
augLabLocation = 'C:\Users\Max Kivits\Documents\MATLAB\Bacheloropdracht\Data\augLabels';
imDir = dir(sprintf('%s\\*.JPG',imLocation)); 
...
for iNoiseOne = 1:length(imDir)
    ...
    for iNoiselocalvar = 1:numberNoise
        ...
        imwrite(tempLab,sprintf('%s\\lab%03d0000%02d00.png',augLabLocation,(iNoiseOne),iNoiselocalvar))
    end
